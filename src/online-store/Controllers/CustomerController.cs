...
namespace online_store.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<Customer> Get(CustomerDTO inboundCustomer)
        {
            var customer = new Customer(inboundCustomer.Username, inboundCustomer.EmailAddress, inboundCustomer.Name);
